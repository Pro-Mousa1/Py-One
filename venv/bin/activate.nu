...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/emobilis/PycharmProjects/afternoonPyOne/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/emobilis/PycharmProjects/afternoonPyOne/venv/bin/deactivate.nu'
